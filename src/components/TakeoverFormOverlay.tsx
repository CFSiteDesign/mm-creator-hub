    ...
    <div className="fixed inset-0 z-[100] bg-black/90 flex flex-col items-center justify-center p-4">
      <div className="w-full max-w-4xl bg-white rounded-3xl overflow-hidden relative h-[90vh] flex flex-col">
        ...
        <div className="p-6 border-b flex items-center justify-between">
          <h2 className="text-2xl font-black">Creator Takeover Application</h2>
        </div>
        ...
        <div className="flex-1 w-full bg-gray-50 relative">
          ...
          <iframe
            src="https://madmonkeyhostels.com/creatorhub/apply/take-over"
            className="w-full h-full border-none"
            title="Mad Monkey Creator Takeover Application Form"
